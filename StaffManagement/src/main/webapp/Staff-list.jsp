				...
				<div class="card">
					<div class="card-body">
							...
							<div class="container">
								...
								<div class="container text-left">
									...
									<a href="Staff-insert.jsp" class="btn btn-secondary">ADD
										New Member</a> <input type="search" id="myInput"
										onkeyup="myFunction()" placeholder="Search for Staff ID"
												...
												<td>
													<div class="btn-group">
														<label class="p-0 mr-1 my-0"> <a
															href="edit?id=<c:out value='${staff.id}' />"><button
								...
								<a href="<%=request.getContextPath()%>/report">
									<button type="button" class="btn btn-success">Member
										Report</button>
								</a>
						...
						<footer class="container">
							<p class="float-right">
								<a href="Staff-insert.jsp">Back to top</a>
							</p>
							<p>
								&copy; 2022 SLIIT. &middot; <a href="#">Privacy</a> &middot; <a
									href="#">Terms</a>
							</p>
						</footer>
					</div>
