	...
	<h2 align="center">Update Staff Member</h2>
		...
		<div class="card">
			...
			<form action="update" method="post">
				...
				<fieldset class="form-group">
					<label>Email</label> <input type="email"placeholder="Type brand here"
				...
				<fieldset class="form-group">
					<label>Phone Number</label> <input type="tel" placeholder="Type quantity here" 
						value="<c:out value='${staff.phoneNumber}' />" class="form-control"
						name="phoneNumber" required="required" maxlength="10" required pattern="[0]{1}[0-9]{9}">
				</fieldset>
